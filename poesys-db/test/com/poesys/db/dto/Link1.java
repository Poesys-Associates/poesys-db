...
public class Link1 extends AbstractTestDto {
  ...
  private class InsertManyToManyLinks extends
    ...
    protected String getClassName() {
      return Link1.class.getName();
    }

    @Override
    protected List<ManyToManyLink> getDtos() {
      return Link1.this.getM2mLinks();
    }
  ...
  private class InsertTernaryLinks extends
    ...
    protected List<TernaryLink> getDtos() {
      return Link1.this.ternaryLinks;
    }
  ...
  /**
   * Create a Link1 object.
   * 
   * @param key the primary key of the object
   * @param col the data column of the object
   */
  public Link1(AbstractSingleValuedPrimaryKey key, String col) {
    this.key = key;
    this.col = col;

    // Create the many-to-many link setter.
  ...
  public int compareTo(IDbDto o) {
    ...
    if (retVal == 0) {
      retVal = col.compareTo(((Link1)o).col);
    }
    return retVal;
  }
  ...
  public void markChildrenDeleted() {
    ...
    for (ManyToManyLink link : m2mLinks) {
      link.cascadeDelete();
    }
