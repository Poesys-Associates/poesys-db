...
public class GuidPrimaryKeyTest extends ConnectionTest {
   ...
   */
  @Test
  public void testSetParams() throws SQLException, IOException, InvalidParametersException {
    Connection connection = getConnection();
    GuidPrimaryKey key1 = new GuidPrimaryKey("col", CLASS_NAME);
    PreparedStatement stmt = connection.prepareStatement("SELECT * FROM TEST WHERE testGuid = ?");
  ...
  public void testGuidPrimaryKeyString() throws InvalidParametersException {
    ...
    try {
      ...
      @SuppressWarnings("unused") GuidPrimaryKey key2 = new GuidPrimaryKey(null, uuid, CLASS_NAME);
      assertTrue(false);
    ...
    try {
      @SuppressWarnings("unused") GuidPrimaryKey key2 =
        new GuidPrimaryKey(colName, null, CLASS_NAME);
      assertTrue(false);
    } catch (InvalidParametersException e) {
      assertTrue(true);
    }
   ...
   */
  @Test
  public void testGuidPrimaryKeyStringString() throws InvalidParametersException {
    final String colName = "col";
    String guid = UUID.randomUUID().toString();
  ...
  public void testGetColumnNames() throws InvalidParametersException, DuplicateKeyNameException {
    final String colName = "col";
    GuidPrimaryKey key = new GuidPrimaryKey(colName, UUID.randomUUID().toString());
