...
/**
 * <p>
 * An implementation of IInsertSql for the ManyToManyLink table that provides an
 * INSERT statement and parameter setting for a many-to-many link.
 * </p>
 * 
 ...
 */
public class InsertSqlM2MLink implements IInsertSql<ManyToManyLink> {
  private static final String SQL1 = "INSERT INTO ManyToManyLink (";
   ...
   */
  public void setParams(PreparedStatement stmt, int next, ManyToManyLink dto)
      throws SQLException {
