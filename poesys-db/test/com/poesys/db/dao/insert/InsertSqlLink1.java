 ...
 */
public class InsertSqlLink1 implements IInsertSql<Link1> {
  private static final String SQL1 = "INSERT INTO Link1 (";
  ...
  @Override
  public void setParams(PreparedStatement stmt, int next, Link1 dto) {
    try {
  ...
  @Override
  public String getParamString(Link1 dto) {
