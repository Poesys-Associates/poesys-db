...
/**
 * <p>
 * An implementation of IInsertSql for the TernaryLink table that provides an
 * INSERT statement and parameter setting for a ternary (n-ary) link.
 * </p>
 * 
 ...
 */
public class InsertSqlTernaryLink implements IInsertSql<TernaryLink> {
  private static final String SQL1 = "INSERT INTO TernaryLink (";
   ...
   *      int, com.poesys.db.dto.IDto)
   */
  public void setParams(PreparedStatement stmt, int next, TernaryLink dto)
      throws SQLException {
