...
abstract public class AbstractBatchInsertSetter<T extends IDbDto, C extends Collection<T>>
   ...
   * order of the statements in the list. The list must include ALL the classes
   * from the root down to the concrete class, even though the type T may be an
   * abstract class somewhere in the middle of the hierarchy. So, for example,
   * D-&gt;C-&gt;B-&gt;A, and you're inserting a nested object of type C because
